        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            ...
            <div className="mb-4 mt-8">
              ...
              <a
                href="mailto:mufeedamuhammed1099@gmail.com"
                className="hover:underline"
              >
                mufeedamuhammed1099@gmail.com
              </a>
            </div>

            <div className="mb-4">
              <FaPhone className="inline-block text-green-400 mr-2" />
              <a href="tel:8129231248" className="hover:underline">
                8129231248
              </a>
            </div>
            ...
            <div className="mb-4">
              ...
              <span>
                Pattillath House, Near Iqbal HSS Ajanur,
                Kanhangad, Kasaragod, Kerala - 671531
              </span>
            </div>
