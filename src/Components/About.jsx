        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            <p className="text-lg mb-8">
              Iam a passionate full-stack developer with a focus on building
              modern and resposive web applications.With a strong foundation in
              both frontend and backend technologies,I strive to create seamless
              and efficient user experiences
            </p>
            <div className="space-y-4">
              <div className="flem items-center">
